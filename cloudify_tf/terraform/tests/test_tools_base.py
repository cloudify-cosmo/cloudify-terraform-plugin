...
from cloudify_tf.terraform import tools_base
...
def test_logger():
    ...
    tool = tools_base.TFTool(*args, **kwargs)
...
def test_download_archive():
    ...
    source = 'https://github.com/cloudify-community/tf-source/' \
    ...
    with patch('cloudify_common_sdk.utils.get_node_instance_dir') as gnid:
        ...
        result = tool.install_binary(
            ...
            executable_file,
            'README.md')
        assert os.stat(result).st_size == 30
